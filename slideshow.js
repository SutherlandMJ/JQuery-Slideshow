    ...
    var methods = {
        init : function( options ) {        
            ...
            return rval = this.each(function(){ 
                ...
                var slideshowButtonsWidth = 37+(14*numSlides);
                $('#slideshow-buttons').width(slideshowButtonsWidth);
		if (numSlides === 1) {
		  $('#slideshow-buttons').prepend('<p class="play"><a href="#" title="Play">Play Slideshow</a></p>');
		} else {
		    ...
		    if (numSlides === 1) {
		      $('#slideshow-buttons ul').append('<li><a href="#slide'+z+'" class="buttonOn" title="Show slide #'+z+'">Show slide #'+z+'</a></li>');
		    } else {
                ...
                if (numSlides !== 1) {methods.show.apply($this);}
            });
        },
